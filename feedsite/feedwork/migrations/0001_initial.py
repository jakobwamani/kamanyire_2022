# Generated by Django 3.2.7 on 2022-08-16 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feedwork.products')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', models.IntegerField()),
                ('quantity', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('logistics', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feedwork.logistics')),
                ('raw_material_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feedwork.raw_materials')),
