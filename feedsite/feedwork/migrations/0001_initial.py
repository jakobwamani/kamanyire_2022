# Generated by Django 3.2.7 on 2022-08-13 17:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feedwork.employee_enrollment')),
            ],
        ),
        migrations.CreateModel(
            name='employment_advance',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField()),
                ('time', models.TimeField()),
